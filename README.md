...
You can download the **standalone executable version** available for **Windows, macOS, and Linux** from the [GitHub Releases page](https://github.com/gosom/google-maps-scraper/releases). Simply run the binary with the `server` argument.
...
```bash
python script.py --kolom <COLUMN_NAME> --nilai <TARGET_VALUE> --mode exclude
```

> **Note:** Default mode is include
